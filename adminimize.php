...
/**
The stylesheet and the initial idea is from Eric A. Meyer (http://meyerweb.com/) and i have written a plugin with many options on the basis of differently user-right and a user-friendly range in admin-area.
*/

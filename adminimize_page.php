			...
			<div class="postbox">
				...
				<div class="inside">
					...
					<form name="export_options" method="get" action="">
						<p><?php _e('You can save a .xml file with your options.', FB_ADMINIMIZE_TEXTDOMAIN ) ?></p>
						<p id="submitbutton">
					...
					<form name="import_options" enctype="multipart/form-data" method="post" action="?page=<?php echo $_GET['page'];?>">
						<?php wp_nonce_field('mw_adminimize_nonce'); ?> 
						<p><?php _e('Choose a Adminimize (<em>.xml</em>) file to upload, then click <em>Upload file and import</em>.', FB_ADMINIMIZE_TEXTDOMAIN ) ?></p>
						<p>
